...
export interface CoverSection {
    title: {
        text: Font;
        position: {
            column_reverse: FlexDirection | string | null; // si no quieres restringir, deja string|null
            align_x: AlignX | string | null;
            align_y: AlignY | string | null;
        };
    };
    date: {
        value: string | null;     // ISO string; si manejas Date en server, conviértelo a string en API
        active: boolean;
        color: string | null;     // hex (#fff/#ffffff)
