...
export default function TableOrganizationPage() {
    ...
    return (
        <>
            ...
            {/* ================= CONTENIDO ================= */}
            <section id="organizacion-por-mesas" style={{
                ...
                <p>
                    ...
                    la <strong>asignación de invitados confirmados a sus mesas</strong>.
                    Todo se realiza de forma visual, ordenada y completamente digital.
                </p>

                <p>
                    Una vez que cuentas con tu <strong>lista de invitados confirmados</strong>,
                ...
                <p>
                    ...
                    en un solo lugar, tus mesas y a tus invitados confirmados.
                ...
                <p>
                    ...
                    Es importante destacar que <strong>solo los invitados confirmados</strong>
                ...
                <p>
                    ...
                    o desde la <strong>tabla de invitados confirmados</strong>,
