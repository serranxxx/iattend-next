...
export default function WhatsAppDeliveryPage() {
    ...
    return (
        <>
            ...
            {/* ================= CONTENIDO ================= */}
            <section id="envios-whatsapp" style={{
                ...
                <p>
                    ...
                    compartir tus invitaciones digitales de manera
                ...
                <p>
                    ...
                    a tus invitados sin afectar tu número personal.
                </p>

                <p>
                    Gracias a esta integración, puedes enviar invitaciones
