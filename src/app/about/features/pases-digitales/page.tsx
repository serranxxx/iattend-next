...
export default function DigitalPassesPage() {
    ...
    return (
        <>
            ...
            {/* ================= CONTENIDO ================= */}
            <section id="pases-digitales" style={{
                ...
                <p>
                    ...
                    Al confirmar su asistencia, cada invitado recibe automáticamente
                ...
                <p>
                    Una vez que un invitado confirma su asistencia,
                ...
                <p>
                    Cuando utilizas el módulo de <strong>organización por mesas</strong>,
                ...
                <p>
                    ...
                    dentro de la invitación, facilitando su visualización
