        ...
        <div className={styles.side_event_main_cont}>
            ...
            <div className={styles.info_cont}>
                ...
                <div className={styles.col} style={{
                    ...
                    <span >{info?.body.address.street} {info?.body.address.number},</span>
                    <span>{info?.body.address.state} {info?.body.address.country}</span>
                </div >
                ...
                {info?.body.address.street && info?.body.address.number && info?.body.address.neighborhood && info?.body.address.zipcode &&
                    info?.body.address.city && info?.body.address.state && info?.body.address.country &&
                    ...
                    <>
                        ...
                        <div className={styles.mapa_container}>
                            <Button className={styles.get_there} type='text'>Como llegar</Button>
                            <iframe
                                title="Mapa"
                                width="100%"
                                height="100%"
