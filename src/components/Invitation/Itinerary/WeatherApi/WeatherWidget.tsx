...
import { SideAddress, SideAddress2, SideEventBody } from "@/types/side_event";
    ...
    <>
      {
        isSide ?
          ...
          <div className={styles.wdiget_container} style={{ backdropFilter:'blur(10px)', border:'1px solid #FFFFFF40', background: '#00000040', fontFamily: invitation?.generals.fonts.body?.typeFace ?? "Poppins"}}>
          ...
          :
          <div className={styles.wdiget_container} style={{ maxWidth: '130px', padding: '12px', gap: '4px', maxHeight: '134px', fontFamily: invitation?.generals.fonts.body?.typeFace ?? 'Poppins' }}>
