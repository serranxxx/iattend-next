...
export const HeroSection = () => {
  ...
  return (
    ...
    //   }}
    >
      <Image src="https://jblcqcxckefmydvtrxbi.supabase.co/storage/v1/object/public/land_page/hero.jpg" alt="" fill style={{ objectFit: "cover", position: "absolute", zIndex: "-1" }} />
